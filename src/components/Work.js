...
import Img2 from "../assets/netmate.png";
          ...
          >
            ...
            <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl">
              ...
              <div>
                {/* link button */}
                <button
                  className="hidden lg:block absolute -bottom-full left-12 group-hover:bottom-6 transition-all duration-700 z-50 text-accent underline underline-offset-2
"
                >
